...
class MouseSelector {
    ...
    public void render(Graphics2D g2) {
        GVector2f pos = Input.getMousePosition().getDiv(StaticConfig.BLOCK_SIZE).toInt().getMul(StaticConfig.BLOCK_SIZE);
        ...
        GCanvas.fillRect(g2, pos.getSub(2), new GVector2f(4, 4));

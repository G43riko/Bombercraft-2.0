...
public class Timer {
    private final static GVector2f TIMER_SIZE         = StaticConfig.BLOCK_SIZE.getMul(1.5f);
    ...
    public void render(@NotNull Graphics2D g2) {
        GVector2f parentPos = parent.getPosition().getSub(parent.getParent().getOffset()).getAdd(parent.getSize().getDiv(
                2));
        GVector2f realPos = parentPos.getSub(TIMER_SIZE.getDiv(2));

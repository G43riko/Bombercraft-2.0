...
public class SimpleGridCollision implements InteractAble {
     ...
     * @param position   - position of grid
    ...
    private void create() {
        ...
        children[1] = new SimpleGridCollision(this, position.add(new GVector2f(halfSize.getXi(), halfSize.getYi())), halfSize);

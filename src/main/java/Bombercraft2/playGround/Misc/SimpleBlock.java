...
public class SimpleBlock implements Visible {
    ...
    @Nullable
    private final GVector2f offset;

    @NotNull
    protected Block.Type type;

    public SimpleBlock(@NotNull GVector2f position, int type, @NotNull SimpleGameAble parent) {
        this(position, type, parent, null);
    }

    public SimpleBlock(@NotNull GVector2f position,
                       int type,
